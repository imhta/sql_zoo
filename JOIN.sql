...
-- from the game table. The ON says how to figure out which rows in 
-- game go with which rows in goal - the matchid from goal must match id from game.
--  (If we wanted to be more clear/specific we could say 
-- ON (game.id=goal.matchid)

-- The code below shows the player (from the goal) and 
-- stadium name (from the game table) for every goal scored.
...
-- List the the dates of the matches and the name of the 
