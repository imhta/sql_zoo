...
-- The query shown gives the number of routes that visit 
...
-- Execute the self join shown and observe that b.stop 
...
-- by joining two copies of the stops table we can refer to stops 
-- by name rather than by number. Change the query so that the services 
-- between 'Craiglockhart' and 'London Road' are shown.
